...
cleos set contract eosio.token $EOSIO_CONTRACT_DIR/build/contracts/eosio.token
cleos set contract eosio.msig $EOSIO_CONTRACT_DIR/build/contracts/eosio.msig
...
cleos set contract eosio $EOSIO_CONTRACT_DIR/build/contracts/eosio.system
